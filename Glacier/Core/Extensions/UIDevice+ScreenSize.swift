...
extension UIDevice {
    ...
    static var hasSmallScreen: Bool {
        // iPhone 5/5S/5C have screen height of 568
        // iPhone 6/6S/7/8/SE have screen height of 667
        // iPhone 6Plus/7Plus/8Plus have screen height of 736
        // Ref - https://www.ios-resolution.com/
        
        let screenHeight = UIScreen.main.bounds.height
        return (screenHeight >= 568 && screenHeight <= 667) || UIDevice.isIphone6PlusOr7PlusOr8Plus
    }
    
    /**
     Returns true if the current device is iPhone 6 Pluse, iPhone 7 Plus or iPhone 8 Plus
     */
    static var isIphone6PlusOr7PlusOr8Plus: Bool {
